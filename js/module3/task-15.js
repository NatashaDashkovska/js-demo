...
// хранятся в переменной defaultSettings.
// Во время создания теста, все или часть
// настроек можно переопределить, они хранятся
// в переменной overrideSettings.

// Для того чтобы получить финальные
// настройки теста, необходимо взять настройки
// по умолчанию и поверх них применить
// переопределённые настройки. Дополни код так,
// чтобы в переменной finalSettings получился
