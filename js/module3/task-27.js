...
// чтобы они работали не с массивом строк, а с массивом
// объектов.
...
// (уже объект) в массив в свойстве potions, но только если
// такого зелья еще нет в инвентаре. В противном случае
// возвращается строка.
// removePotion(potionName) - удаляет объект зелья с
// именем potionName из массива в свойстве potions.
...
const atTheOldToad = {
  ...
  updatePotionName(oldName, newName) {
    ...
    const equalIndex = this.potions[potionIndex];
    equalIndex.name = newName;
  },
  // Change code above this line
};
