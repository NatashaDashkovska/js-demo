...
// того какая именно из трех функция(add, mult, sub) будет передана в качестве cb.

function add(accum, element) {
  return accum + element;
}
function sub(accum, element) {
  return accum - element;
}
function mult(accum, element) {
  return accum * element;
}
