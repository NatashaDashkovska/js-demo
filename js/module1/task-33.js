...
//   сообщение о результате сравнения, хранящееся в переменной
//    message.
...
// не удобвлетворяет ни одному из предыдущих условий, в
// переменную message записывается строка
//  "Access denied, wrong password!".
// Проведи рефакторинг кода, заменив инструкцию
// if..else на switch, и не забудь о блоке default (аналог else).
