...
//  `prompt` до тех пор, пока
// посетитель на нажмет `Cancel` и каждый раз добавляет
// введенное значение к общей
// сумме.

// - При загрузке страницы пользователю предлагается в
// `prompt` ввести число. Ввод
...
// кнопку `Cancel`, показать
//   `alert` со строкой `'Общая сумма чисел равна [сумма]'`.

// > 🔔 Делать проверку того, что пользователь ввел именно
//  число, а не произвольный
// > набор символов, не нужно. Если хочешь, в случае
// некорректного ввода, показывай> `alert` с текстом
//  `'Было введено не число, попробуйте еще раз'`, при этом
// > результат `prompt` плюсовать к общей сумме не
// нужно, после чего снова
